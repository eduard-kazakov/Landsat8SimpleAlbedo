...
# Simple broadband albedo retrieval from Landsat 8 L1c imagery
# Supported albedo methods: tasimu, olmedo, liang, beg
# Supported atmospherical correction methods: raw, SREM, DOS
#
# References:
...
class AlbedoRetriever():
    ...
    def __init__(self, metadata_file, temp_dir=None, albedo_method='olmedo', correction_method='raw',
                        dem_file=None,
                        angles_file=None,
                        usgs_utils=None,
